    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-text3">
          Account creation now happens only after a verified Premium purchase. Signed-in non-premium access keeps anon product privileges.
        </p>
      </div>

      {!claimToken ? (
        <div className="space-y-3 rounded-2xl border border-stroke bg-surface-1 p-4 text-sm text-text2">
          <p>Public free sign-up has been removed. Start Premium first, then create an account to claim it.</p>
