...
import { isTwilioVerifyConfigured, startSmsVerification } from '@/lib/notifications/twilio';
...
export async function POST(request: Request) {
  ...
  if (parsed.data.sms_consent !== true) {
  ...
  try {
    ...
    console.error('sms verify send error', err);
