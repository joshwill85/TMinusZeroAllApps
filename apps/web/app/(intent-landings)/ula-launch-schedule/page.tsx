...
export function generateMetadata() {
  return buildLaunchIntentLandingMetadata('ula-launch-schedule');
}

export default async function UlaLaunchSchedulePage() {
  return renderLaunchIntentLandingPage('ula-launch-schedule');
}
