...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description =
    'Artemis I mission recap with timeline context, tracked launch entries, and links to ongoing Artemis mission coverage.';
  const images = [
    {
    ...
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-10 md:px-8">
      ...
      <header className="space-y-4">
        ...
        <p className="max-w-3xl text-sm text-text2">
          Artemis I was the uncrewed lunar test mission that opened NASA&apos;s
          Artemis era. This route provides mission recap context and launch
          timeline references while current planning focus shifts to Artemis II
          and Artemis III.
        </p>
      ...
      <section className="rounded-2xl border border-stroke bg-surface-1 p-4">
        ...
        <p className="mt-2 text-sm text-text2">
          Artemis I validated the SLS-Orion stack through a lunar flight profile
          and recovery sequence, providing data used to progress crewed Artemis
          objectives.
        </p>
        {featuredLaunch ? (
          <div className="mt-3 rounded-xl border border-stroke bg-surface-0 p-3">
            ...
            <Link
              ...
              className="mt-2 inline-block text-sm font-semibold text-text1 hover:text-primary"
            >
              {featuredLaunch.name}
            </Link>
          ...
          <p className="mt-3 text-sm text-text2">
            No Artemis I launch record is currently present in the feed
            snapshot.
          </p>
        )}
      </section>
      ...
      <LaunchList
        title="Artemis I launch timeline entries"
        launches={launches}
        emptyLabel="No Artemis I entries are currently present in the mission feed snapshot."
      />
