...
values
  ('ll2_future_launch_sync_job_enabled', 'false'::jsonb),
  ('ll2_future_launch_sync_page_limit', '100'::jsonb),
  ('ll2_future_launch_sync_pages_per_run', '10'::jsonb),
  ('ll2_future_launch_sync_horizon_days', '3650'::jsonb)
...
values
  ('ll2_future_launch_sync', 'll2-future-launch-sync', 43200, 1800, true, 3, public.managed_scheduler_next_run(now(), 43200, 1800))
