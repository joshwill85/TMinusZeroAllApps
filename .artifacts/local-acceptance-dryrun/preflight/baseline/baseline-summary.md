...
Generated: 2026-03-10T01:21:50.925Z
...
- Requests per route: 15
- Warmup requests per route: 5

| route | p50 ms | p95 ms | mean ms |
| --- | ---: | ---: | ---: |
| `/api/v1/launches?limit=20&region=all` | 8.370 | 17.115 | 8.533 |
| `/api/v1/search?q=starlink&limit=8` | 1.487 | 2.037 | 1.479 |
